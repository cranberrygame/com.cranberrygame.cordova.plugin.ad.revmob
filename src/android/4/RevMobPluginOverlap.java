...
*/	
	...
	protected RevMobAdsListener revmobListener;
	...
	public void _setUp(String mediaId, boolean isOverlap) {
		...
		revmob = RevMob.startWithListenerForWrapper(plugin.getCordova().getActivity(), mediaId, revmobListener);
...
*/
	...
	public void _preloadPopupAd() {
		popup = revmob.createPopup(plugin.getCordova().getActivity(), revmobListener);
	}
	...
	public void _showPopupAd() {
		if (popup != null) {
			...
			revmob.showPopup(plugin.getCordova().getActivity());
		}
	}
	
	public void _preloadAdLinkAd() {
		link = revmob.createAdLink(plugin.getCordova().getActivity(), revmobListener);
	}
	...
	public void _showAdLinkAd() {
		if (link != null) {
			...
			revmob.openAdLink(plugin.getCordova().getActivity(), revmobListener);
		}
	}
...
//		    bannerView.pause();
    ...
    public void onResume(boolean multitasking) {
		revmob = RevMob.startWithListener(plugin.getCordova().getActivity(), revmobListener);        
        if (bannerView != null) {
//            bannerView.resume();
        }
    }
